...
- `YOOKASSA_SHOP_ID` — только numeric `shopId` (из кабинета магазина)
- `YOOKASSA_SECRET_KEY` — только API Secret Key (`test_...` или `live_...`)
- OAuth-токен сюда не подходит и приводит к ошибке `authorization method is not allowed`
